CREATE TABLE dm.dm_hlw_shop_info (
    ...
    card_bal Nullable(decimal(18,2)),
    card_avg_year Nullable(decimal(18,2)),
    card_avg_mth Nullable(decimal(18,2)),
    all_dep_bal Nullable(decimal(18,2)),
    legal_name String,
    uid String,
    ...
    recom_phone String,
    tran_cnt_year int,
    tran_amt_year Nullable(decimal(18,2)),
    tran_cnt_mth int,
    tran_amt_mth Nullable(decimal(18,2)),
    class_year String,
    class_mth String,
    online_loan_bal Nullable(decimal(18,2)),
    all_loan_bal Nullable(decimal(18,2)),
    etl_dt String
)
ENGINE = MergeTree
ORDER BY shop_code;
...
CREATE TABLE dm.dm_v_as_sjyh_info (
    ...
    is_djk String,
    is_sbk String,
    interbank_lmtamt Nullable(decimal(18,2)),
    innerbank_lmtamt Nullable(decimal(18,2)),
    tran_lmtamt Nullable(decimal(18,2)),
    last_tran_dt String,
    etl_dt String
)
ENGINE = MergeTree
